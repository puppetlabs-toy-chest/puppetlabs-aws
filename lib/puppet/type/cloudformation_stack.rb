...
Puppet::Type.newtype(:cloudformation_stack) do
  ...
  newproperty(:disable_rollback) do
  ...
  newparam(:policy_body) do
    desc 'Structure containing the stack policy body. For more information, go to Prevent Updates to Stack Resources in the AWS CloudFormation User Guide. You can specify either the policy_body or the policy_url parameter, but not both.'
    validate do |value|
